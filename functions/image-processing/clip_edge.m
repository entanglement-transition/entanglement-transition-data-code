function new_edge = clip_edge(edge,z1,z2)
    if size(edge,1) < 1
        new_edge = edge;
        return;
    end
    ...
    interpolation_factor1 = (z1 - u(3))/(v(3) - u(3));
    interpolation_factor2 = (z2 - v(3))/(u(3) - v(3));
...
%         x1 = -(u(1) - v(1))*(z1-v(3))/(u(3)-v(3)) + v(1);
%         y1 = -(u(2) - v(2))*(z1-v(3))/(u(3)-v(3)) + v(2);
%         u_new = [x1,y1 z1];
%         v_new = v;
