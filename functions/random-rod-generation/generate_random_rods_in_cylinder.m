function all_edges = generate_random_rods_in_cylinder(num_rods,container_radius,container_height,edge_length,rod_radius)
...
while 1
    ...
    if is_intersect2(edge,neighbor_edges,rod_radius) | ~is_outside_cylinder(edge,container_radius,container_height)
        continue
    else
