...
%             end
        ...
        function background(o, varargin)
            p = inputParser;            
            ...
            % Write
            fprintf(o.fh, ['background { color rgb <%0.2f, %0.2f, %0.2f> }\n'], ...
        ...
        function tex = texture(o, varargin)
            ...
            addParameter(p,'filter',      0,    @o.check_positive_float);
            ...
            if (~ismember('pigment', p.UsingDefaults))
                tex = sprintf(['texture { pigment{ color rgb <%0.2f, %0.2f, %0.2f> filter %0.4f}\n'...
                               '          finish { %s }}\n'], ...                               
        ...
        function img = render(o)
            ...
            if isunix
                ...
                system(sprintf('"%s" %s/%s +O%s  +L/Users/yeonsu/povray/include/', o.pov_path, o.out_dir, o.scene_file, o.image_file));
            elseif ispc
